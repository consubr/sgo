...
@Named
@RequestScoped
public class RelatorioOrcamentosEmitidosMB implements Serializable {
	...
	public void emitir() {
		...
		ExecutorRelatorio executor = new ExecutorRelatorio("/reports/relatorio_orcamentos_emitidos.jasper",
				this.response, parametros, "Orçamentos emitidos.pdf");
